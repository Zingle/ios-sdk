...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/Analytics-iOS9.3/Analytics.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/SDWebImage-iOS9.3/SDWebImage.framework"
  install_framework "$BUILT_PRODUCTS_DIR/Socket.IO-Client-Swift-iOS9.3/SocketIO.framework"
