...
- (void)testLabelList
{
    [ZNGLabelClient labelListWithParameters:nil withServiceId:[self serviceId] success:^(NSArray *labels) {
        
        XCTAssert(labels != nil, @"Labels are nil!");
...
- (void)testLabelById
{
    [ZNGLabelClient labelWithId:@"d5a7bb87-6c55-4334-bece-952f70522fb5" withServiceId:[self serviceId] success:^(ZNGLabel *label) {
...
- (void)testCreateAndDeleteLabel
{
    ...
    [ZNGLabelClient saveLabel:label withServiceId:[self serviceId] success:^(ZNGLabel *label) {
        
        XCTAssert(label != nil, @"Label is nil!");
        
        [ZNGLabelClient deleteLabelWithId:label.labelId withServiceId:[self serviceId] success:^{
...
- (void)testUpdateLabel
{
    ...
    [ZNGLabelClient updateLabelWithId:@"069c609b-7e53-4f08-842e-fc2a9d1d5c76" withServiceId:[self serviceId] withParameters:params success:^(ZNGLabel *label) {
