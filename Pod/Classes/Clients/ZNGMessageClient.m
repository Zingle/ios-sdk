...
+ (void)sendMessage:(ZNGNewMessage *)newMessage
      withServiceId:(NSString *)serviceId
            ...
            failure:(void (^)(ZNGError *error))failure
{
    if (newMessage.senderType == nil) [NSException raise:NSInvalidArgumentException format:@"Required argument: newMessage.senderType"];
    if (newMessage.sender == nil) [NSException raise:NSInvalidArgumentException format:@"Required argument: newMessage.sender"];
    if (newMessage.recipientType == nil) [NSException raise:NSInvalidArgumentException format:@"Required argument: newMessage.recipientType"];
    if (newMessage.recipients == nil) [NSException raise:NSInvalidArgumentException format:@"Required argument: newMessage.recipients"];
    if (newMessage.channelTypeIds == nil) [NSException raise:NSInvalidArgumentException format:@"Required argument: newMessage.channelTypeIds"];
