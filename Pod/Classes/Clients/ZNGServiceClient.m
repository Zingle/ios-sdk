            ...
            failure:(void (^)(ZNGError* error))failure
{
    if (service.account == nil) {
        [NSException raise:NSInvalidArgumentException format:@"Required argument: service.account"];
    }
    
    if (service.displayName == nil) {
        [NSException raise:NSInvalidArgumentException format:@"Required argument: service.displayName"];
    }
    
    if (service.timeZone == nil) {
        [NSException raise:NSInvalidArgumentException format:@"Required argument: service.timeZone"];
    }
    
    if (service.plan == nil) {
        [NSException raise:NSInvalidArgumentException format:@"Required argument: service.plan"];
    }
    
    if (service.serviceAddress == nil) {
        [NSException raise:NSInvalidArgumentException format:@"Required argument: service.serviceAddress"];
    }
