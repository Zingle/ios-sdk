...
/**
 *  The `ZNGBaseViewController` class is an abstract class that represents a view controller whose content consists of
 *  a `ZNGCollectionView` and `ZNGInputToolbar` and is specialized to display a messaging interface.
 *
 ...
 */
@property (weak, nonatomic, readonly) ZNGCollectionView *collectionView;

/**
 *  Returns the input toolbar view object managed by this view controller.
 *  This view controller is the toolbar's delegate.
 */
@property (weak, nonatomic, readonly) ZNGInputToolbar *inputToolbar;

/**
 *  Returns the keyboard controller object used to manage the software keyboard.
 */
@property (strong, nonatomic) ZNGKeyboardController *keyboardController;
 ...
 *  The default value is the string returned by `[ZNGCollectionViewCellOutgoing cellReuseIdentifier]`.
 ...
 *  The default value is the string returned by `[ZNGCollectionViewCellOutgoing mediaCellReuseIdentifier]`.
 *  This value must not be `nil`.
 *
 *  @see ZNGCollectionViewCellOutgoing.
 *
 ...
 *  The default value is the string returned by `[ZNGCollectionViewCellIncoming cellReuseIdentifier]`.
 *  This value must not be `nil`.
 *
 ...
 *  The default value is the string returned by `[ZNGCollectionViewCellIncoming mediaCellReuseIdentifier]`.
 *  This value must not be `nil`.
 *
 *  @see ZNGCollectionViewCellIncoming.
 *
...
/**
 *  Returns the `UINib` object initialized for a `ZNGBaseViewController`.
 *
...
/**
 *  Creates and returns a new `ZNGBaseViewController` object.
 *
 *  @discussion This is the designated initializer for programmatic instantiation.
 *
 *  @return An initialized `ZNGBaseViewController` object if successful, `nil` otherwise.
 */
