...
@class ZNGKeyboardController;

/**
 *  Posted when the system keyboard frame changes.
 *  The object of the notification is the `ZNGKeyboardController` object. 
 *  The `userInfo` dictionary contains the new keyboard frame for key
 *  `ZNGKeyboardControllerUserInfoKeyKeyboardDidChangeFrame`.
 */
FOUNDATION_EXPORT NSString * const ZNGKeyboardControllerNotificationKeyboardDidChangeFrame;

/**
 *  Contains the new keyboard frame wrapped in an `NSValue` object.
 */
FOUNDATION_EXPORT NSString * const ZNGKeyboardControllerUserInfoKeyKeyboardDidChangeFrame;


/**
 *  The `ZNGKeyboardControllerDelegate` protocol defines methods that 
 *  allow you to respond to the frame change events of the system keyboard.
 *
 *  A `ZNGKeyboardController` object also posts the `ZNGKeyboardControllerNotificationKeyboardDidChangeFrame`
 *  in response to frame change events of the system keyboard.
 */
@protocol ZNGKeyboardControllerDelegate <NSObject>
...
/**
 *  An instance of `ZNGKeyboardController` manages responding to the hiding and showing 
 ...
 *  
 *  When the system keyboard frame changes, it posts the `ZNGKeyboardControllerNotificationKeyboardDidChangeFrame`.
 */
@interface ZNGKeyboardController : NSObject

/**
 *  The object that acts as the delegate of the keyboard controller.
 */
@property (weak, nonatomic) id<ZNGKeyboardControllerDelegate> delegate;
 ...
 *
 *  @return An initialized `ZNGKeyboardController` if created successfully, `nil` otherwise.
 */
- (instancetype)initWithTextView:(UITextView *)textView
                     contextView:(UIView *)contextView
            panGestureRecognizer:(UIPanGestureRecognizer *)panGestureRecognizer
                        delegate:(id<ZNGKeyboardControllerDelegate>)delegate;
