...
NSString * const ZNGKeyboardControllerNotificationKeyboardDidChangeFrame = @"ZNGKeyboardControllerNotificationKeyboardDidChangeFrame";
NSString * const ZNGKeyboardControllerUserInfoKeyKeyboardDidChangeFrame = @"ZNGKeyboardControllerUserInfoKeyKeyboardDidChangeFrame";

static void * kZNGKeyboardControllerKeyValueObservingContext = &kZNGKeyboardControllerKeyValueObservingContext;

typedef void (^ZNGAnimationCompletionBlock)(BOOL finished);



@interface ZNGKeyboardController () <UIGestureRecognizerDelegate>
...
@implementation ZNGKeyboardController
    ...
    if (keyboardView && !_zng_isObserving) {
        [_keyboardView addObserver:self
                        forKeyPath:NSStringFromSelector(@selector(frame))
                           ...
                           context:kZNGKeyboardControllerKeyValueObservingContext];
...
- (void)zng_notifyKeyboardFrameNotificationForFrame:(CGRect)frame
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:ZNGKeyboardControllerNotificationKeyboardDidChangeFrame
                                                        object:self
                                                      userInfo:@{ ZNGKeyboardControllerUserInfoKeyKeyboardDidChangeFrame : [NSValue valueWithCGRect:frame] }];
}
...
{
    if (context == kZNGKeyboardControllerKeyValueObservingContext) {
