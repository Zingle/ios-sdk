...
@property (nonatomic, strong, nullable) IBOutlet UIVisualEffectView * typingIndicatorBlurView;
@property (nonatomic, assign) CGFloat extraSpaceAboveTypingIndicator;   // Defaults to 10.0
