...
/**
 *  An instance of `ZNGTimestampFormatter` is a singleton object that provides an efficient means 
 *  for creating attributed and non-attributed string representations of `NSDate` objects. 
 *  It is intended to be used as the method by which you display timestamps in a `ZNGCollectionView`.
 */
@interface ZNGTimestampFormatter : NSObject

/**
 *  Returns the cached date formatter object used by the `ZNGTimestampFormatter` shared instance.
 */
 ...
 */
+ (ZNGTimestampFormatter *)sharedFormatter;
