...
/**
 *  A constant that describes the default height for all label subviews in a `ZNGCollectionViewCell`.
 *
 *  @see ZNGCollectionViewCell.
 */
FOUNDATION_EXPORT const CGFloat kZNGCollectionViewCellLabelHeightDefault;

/**
 *  A constant that describes the default size for avatar images in a `ZNGCollectionViewFlowLayout`.
 */
FOUNDATION_EXPORT const CGFloat kZNGCollectionViewAvatarSizeDefault;



/**
 *  The `ZNGCollectionViewFlowLayout` is a concrete layout object that inherits 
 *  from `UICollectionViewFlowLayout` and organizes message items in a vertical list.
 *  Each `ZNGCollectionViewCell` in the layout can display messages of arbitrary sizes and avatar images, 
 ...
 *  defined in `ZNGCollectionViewDelegateFlowLayout`.
 *
 *  @see ZNGCollectionViewDelegateFlowLayout.
 *  @see ZNGCollectionViewCell.
 */
@interface ZNGCollectionViewFlowLayout : UICollectionViewFlowLayout
...
@property (readonly, nonatomic) ZNGCollectionView *collectionView;
#pragma clang diagnostic pop

/**
 *  The object that the layout uses to calculate bubble sizes.
 *  The default value is an instance of `ZNGBubblesSizeCalculator`.
 */
@property (strong, nonatomic) id<ZNGBubbleSizeCalculating> bubbleSizeCalculator;
 ...
 *  in your `ZNGBaseViewController` subclass.
 *
 ...
 *  `ZNGCollectionViewCell` in the collectionView. 
 *  
...
/**
 *  The horizontal spacing used to lay out the `messageBubbleContainerView` frame within each `ZNGCollectionViewCell`.
...
/**
 *  The inset of the frame of the text view within the `messageBubbleContainerView` of each `ZNGCollectionViewCell`.
...
/**
 *  The inset of the text container's layout area within the text view's content area in each `ZNGCollectionViewCell`. 
 ...
 *  You may use `kZNGCollectionViewAvatarSizeDefault` to size your avatars to the default value.
 */
...
/**
 *  Computes and returns the size of the `messageBubbleImageView` property of a `ZNGCollectionViewCell`
