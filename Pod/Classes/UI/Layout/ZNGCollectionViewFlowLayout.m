...
const CGFloat kZNGCollectionViewCellLabelHeightDefault = 20.0f;
const CGFloat kZNGCollectionViewAvatarSizeDefault = 30.0f;


@interface ZNGCollectionViewFlowLayout ()
...
- (void)zng_configureMessageCellLayoutAttributes:(ZNGCollectionViewLayoutAttributes *)layoutAttributes;
...
@implementation ZNGCollectionViewFlowLayout
...
- (void)zng_configureFlowLayout
{
    ...
    CGSize defaultAvatarSize = CGSizeMake(kZNGCollectionViewAvatarSizeDefault, kZNGCollectionViewAvatarSizeDefault);
...
{
    return [ZNGCollectionViewLayoutAttributes class];
}

+ (Class)invalidationContextClass
{
    return [ZNGCollectionViewFlowLayoutInvalidationContext class];
}
...
- (void)setBubbleSizeCalculator:(id<ZNGBubbleSizeCalculating>)bubbleSizeCalculator
{
...
- (void)setSpringinessEnabled:(BOOL)springinessEnabled
{
    ...
    [self invalidateLayoutWithContext:[ZNGCollectionViewFlowLayoutInvalidationContext context]];
}
...
- (id<ZNGBubbleSizeCalculating>)bubbleSizeCalculator
{
    if (_bubbleSizeCalculator == nil) {
        _bubbleSizeCalculator = [ZNGBubblesSizeCalculator new];
    }
...
- (void)invalidateLayoutWithContext:(ZNGCollectionViewFlowLayoutInvalidationContext *)context
{
...
- (NSArray *)layoutAttributesForElementsInRect:(CGRect)rect
{
    ...
    [attributesInRect enumerateObjectsUsingBlock:^(ZNGCollectionViewLayoutAttributes *attributesItem, NSUInteger idx, BOOL *stop) {
...
{
    ZNGCollectionViewLayoutAttributes *customAttributes = (ZNGCollectionViewLayoutAttributes *)[super layoutAttributesForItemAtIndexPath:indexPath];
...
- (void)prepareForCollectionViewUpdates:(NSArray *)updateItems
{
    ...
    [updateItems enumerateObjectsUsingBlock:^(UICollectionViewUpdateItem *updateItem, NSUInteger index, BOOL *stop) {
        if (updateItem.updateAction == UICollectionUpdateActionInsert) {
            ...
            ZNGCollectionViewLayoutAttributes *attributes = [ZNGCollectionViewLayoutAttributes layoutAttributesForCellWithIndexPath:updateItem.indexPathAfterUpdate];
...
- (CGSize)sizeForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ZNGCollectionViewLayoutAttributes *attributes = (ZNGCollectionViewLayoutAttributes *)[self layoutAttributesForItemAtIndexPath:indexPath];
