//
//  ZNGCollectionViewFlowLayoutInvalidationContext.h
//  Pods
//
...
/**
 *  A `ZNGCollectionViewFlowLayoutInvalidationContext` object specifies properties for 
 ...
 *
 */
@interface ZNGCollectionViewFlowLayoutInvalidationContext : UICollectionViewFlowLayoutInvalidationContext
...
/**
 *  Creates and returns a new `ZNGCollectionViewFlowLayoutInvalidationContext` object.
 *
 *  @discussion When you need to invalidate the `ZNGCollectionViewFlowLayout` object for your
 *  `ZNGBaseViewController` subclass, you should use this method to instantiate a new invalidation 
