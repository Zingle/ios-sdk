...
/**
 *  A `ZNGAvatarImage` model object represents an avatar image.
 ...
 */
@interface ZNGAvatarImage : NSObject <ZNGMessageAvatarImageDataSource, NSCopying>
 ...
 *
 *  @return An initialized `ZNGAvatarImage` object if successful, `nil` otherwise.
 */
