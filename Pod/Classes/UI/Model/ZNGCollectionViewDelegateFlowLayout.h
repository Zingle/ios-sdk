//
//  ZNGCollectionViewDelegateFlowLayout.h
//  Pods
//
...
/**
*  The `ZNGCollectionViewDelegateFlowLayout` protocol defines methods that allow you to
*  manage additional layout information for the collection view and respond to additional actions on its items.
*  The methods of this protocol are all optional.
*/
@protocol ZNGCollectionViewDelegateFlowLayout <UICollectionViewDelegateFlowLayout>
