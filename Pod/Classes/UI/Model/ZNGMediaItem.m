...
- (UIView *)mediaPlaceholderView
{
    if (self.cachedPlaceholderView == nil) {
        ...
        UIView *view = [ZNGMediaPlaceholderView viewWithActivityIndicator];
        view.frame = CGRectMake(0.0f, 0.0f, size.width, size.height);
        [ZNGMediaViewBubbleImageMasker applyBubbleImageMaskToMediaView:view isOutgoing:self.appliesMediaViewMaskAsOutgoing];
...
- (BOOL)isEqual:(id)object
{
    ...
    ZNGMediaItem *item = (ZNGMediaItem *)object;
