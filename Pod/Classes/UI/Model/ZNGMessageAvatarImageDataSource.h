 ...
 *  a `ZNGBaseViewController` and `ZNGCollectionView` interact with avatar image model objects.
 *
 ...
 *
 *  A concrete class that conforms to this protocol is provided in the library. See `ZNGAvatarImage`.
 *
 *  @see ZNGAvatarImage.
 */
