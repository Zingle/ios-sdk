...
@class ZNGCollectionViewCell;

/**
 *  The `ZNGCollectionViewCellDelegate` protocol defines methods that allow you to manage
 *  additional interactions within the collection view cell.
 */
@protocol ZNGCollectionViewCellDelegate <NSObject>
...
/**
 *  The `ZNGCollectionViewCell` is an abstract base class that presents the content for
 ...
 */
@interface ZNGCollectionViewCell : UICollectionViewCell

/**
 *  The object that acts as the delegate for the cell.
 */
@property (weak, nonatomic) id<ZNGCollectionViewCellDelegate> delegate;

/**
 *  Returns the label that is pinned to the top of the cell.
 *  This label is most commonly used to display message timestamps.
 */
@property (weak, nonatomic, readonly) ZNGCellLabel *cellTopLabel;
 ...
 */
@property (weak, nonatomic, readonly) ZNGCellLabel *messageBubbleTopLabel;
 ...
 */
@property (weak, nonatomic, readonly) ZNGCellLabel *cellBottomLabel;
 ...
 */
@property (weak, nonatomic, readonly) ZNGCellTextView *textView;
