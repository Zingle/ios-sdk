...
@class ZNGInputToolbar;


/**
 *  The `ZNGInputToolbarDelegate` protocol defines methods for interacting with
 *  a `ZNGInputToolbar` object.
 */
@protocol ZNGInputToolbarDelegate <UIToolbarDelegate>
 ...
 */
- (void)messagesInputToolbar:(ZNGInputToolbar *)toolbar
 ...
 *
 *  @return An initialized `ZNGToolbarContentView` if successful, otherwise `nil`.
 */
