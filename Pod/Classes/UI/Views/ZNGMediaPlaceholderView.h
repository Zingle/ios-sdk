...
/**
 *  A `ZNGMediaPlaceholderView` object represents a loading or placeholder
 ...
 */
@interface ZNGMediaPlaceholderView : UIView
 ...
 *
 *  @discussion When initializing a `ZNGMediaPlaceholderView` with this method,
 *  its imageView property will be nil.
 *
 *  @return An initialized `ZNGMediaPlaceholderView` object if successful, `nil` otherwise.
 */
