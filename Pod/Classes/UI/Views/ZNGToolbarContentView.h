 ...
 */
FOUNDATION_EXPORT const CGFloat kZNGToolbarContentViewHorizontalSpacingDefault;

/**
 *  A `ZNGToolbarContentView` represents the content displayed in a `ZNGInputToolbar`.
 ...
 */
@interface ZNGToolbarContentView : UIView

/**
 *  Returns the text view in which the user composes a message.
 */
@property (weak, nonatomic, readonly) ZNGComposerTextView *textView;
...
/**
 *  Returns the `UINib` object initialized for a `ZNGToolbarContentView`.
 *
