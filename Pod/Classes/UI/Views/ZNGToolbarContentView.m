...
const CGFloat kZNGToolbarContentViewHorizontalSpacingDefault = 8.0f;


@interface ZNGToolbarContentView ()

@property (weak, nonatomic) IBOutlet ZNGComposerTextView *textView;
...
@implementation ZNGToolbarContentView

#pragma mark - Class methods

+ (UINib *)nib
{
    return [UINib nibWithNibName:NSStringFromClass([ZNGToolbarContentView class])
                          bundle:[NSBundle bundleForClass:[ZNGToolbarContentView class]]];
}
...
- (void)awakeFromNib
{
    ...
    self.leftHorizontalSpacingConstraint.constant = kZNGToolbarContentViewHorizontalSpacingDefault;
    self.rightHorizontalSpacingConstraint.constant = kZNGToolbarContentViewHorizontalSpacingDefault;
