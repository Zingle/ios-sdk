//
//  ZNGTypingIndicatorFooterView.h
//  Pods
//
...
/**
 *  A constant defining the default height of a `ZNGTypingIndicatorFooterView`.
 */
FOUNDATION_EXPORT const CGFloat kZNGTypingIndicatorFooterViewHeight;

/**
 *  The `ZNGTypingIndicatorFooterView` class implements a reusable view that can be placed
 *  at the bottom of a `ZNGCollectionView`. This view represents a typing indicator 
 *  for incoming messages.
 */
@interface ZNGTypingIndicatorFooterView : UICollectionReusableView
