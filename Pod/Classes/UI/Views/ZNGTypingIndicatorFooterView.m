...
const CGFloat kZNGTypingIndicatorFooterViewHeight = 46.0f;


@interface ZNGTypingIndicatorFooterView ()
...
@implementation ZNGTypingIndicatorFooterView

#pragma mark - Class methods

+ (UINib *)nib
{
    return [UINib nibWithNibName:NSStringFromClass([ZNGTypingIndicatorFooterView class])
                          bundle:[NSBundle bundleForClass:[ZNGTypingIndicatorFooterView class]]];
}

+ (NSString *)footerReuseIdentifier
{
    return NSStringFromClass([ZNGTypingIndicatorFooterView class]);
}
                 ...
                 forCollectionView:(UICollectionView *)collectionView
{
    ...
    ZNGBubbleImageFactory *bubbleImageFactory = [[ZNGBubbleImageFactory alloc] init];
