//
//  ZNGMessagesKeyboardController.h
//  Pods
//
...
@class ZNGMessagesKeyboardController;

/**
 *  Posted when the system keyboard frame changes.
 *  The object of the notification is the `ZNGMessagesKeyboardController` object. 
 *  The `userInfo` dictionary contains the new keyboard frame for key
 *  `ZNGMessagesKeyboardControllerUserInfoKeyKeyboardDidChangeFrame`.
 */
FOUNDATION_EXPORT NSString * const ZNGMessagesKeyboardControllerNotificationKeyboardDidChangeFrame;

/**
 *  Contains the new keyboard frame wrapped in an `NSValue` object.
 */
FOUNDATION_EXPORT NSString * const ZNGMessagesKeyboardControllerUserInfoKeyKeyboardDidChangeFrame;


/**
 *  The `ZNGMessagesKeyboardControllerDelegate` protocol defines methods that 
 *  allow you to respond to the frame change events of the system keyboard.
 *
 *  A `ZNGMessagesKeyboardController` object also posts the `ZNGMessagesKeyboardControllerNotificationKeyboardDidChangeFrame`
 *  in response to frame change events of the system keyboard.
 */
@protocol ZNGMessagesKeyboardControllerDelegate <NSObject>
...
/**
 *  An instance of `ZNGMessagesKeyboardController` manages responding to the hiding and showing 
 ...
 *  
 *  When the system keyboard frame changes, it posts the `ZNGMessagesKeyboardControllerNotificationKeyboardDidChangeFrame`.
 */
@interface ZNGMessagesKeyboardController : NSObject

/**
 *  The object that acts as the delegate of the keyboard controller.
 */
@property (weak, nonatomic) id<ZNGMessagesKeyboardControllerDelegate> delegate;
 ...
 *
 *  @return An initialized `ZNGMessagesKeyboardController` if created successfully, `nil` otherwise.
 */
