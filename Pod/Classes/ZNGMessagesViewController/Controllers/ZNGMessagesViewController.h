...
/**
 *  The `ZNGMessagesViewController` class is an abstract class that represents a view controller whose content consists of
 *  a `ZNGMessagesCollectionView` and `ZNGMessagesInputToolbar` and is specialized to display a messaging interface.
 *
 *  @warning This class is intended to be subclassed. You should not use it directly.
 */
@interface ZNGMessagesViewController : UIViewController <ZNGMessagesCollectionViewDataSource,
                                                         ZNGMessagesCollectionViewDelegateFlowLayout,
                                                         UITextViewDelegate>
 ...
 */
@property (weak, nonatomic, readonly) ZNGMessagesCollectionView *collectionView;

/**
 *  Returns the input toolbar view object managed by this view controller.
 *  This view controller is the toolbar's delegate.
 */
@property (weak, nonatomic, readonly) ZNGMessagesInputToolbar *inputToolbar;

/**
 *  Returns the keyboard controller object used to manage the software keyboard.
 */
@property (strong, nonatomic) ZNGMessagesKeyboardController *keyboardController;
 ...
 *  The default value is the string returned by `[ZNGMessagesCollectionViewCellOutgoing cellReuseIdentifier]`.
 ...
 *  The default value is the string returned by `[ZNGMessagesCollectionViewCellOutgoing mediaCellReuseIdentifier]`.
 *  This value must not be `nil`.
 *
 *  @see ZNGMessagesCollectionViewCellOutgoing.
 *
 ...
 *  The default value is the string returned by `[ZNGMessagesCollectionViewCellIncoming cellReuseIdentifier]`.
 *  This value must not be `nil`.
 *
 ...
 *  The default value is the string returned by `[ZNGMessagesCollectionViewCellIncoming mediaCellReuseIdentifier]`.
 *  This value must not be `nil`.
 *
 *  @see ZNGMessagesCollectionViewCellIncoming.
 *
...
/**
 *  Returns the `UINib` object initialized for a `ZNGMessagesViewController`.
 *
...
/**
 *  Creates and returns a new `ZNGMessagesViewController` object.
 *
 *  @discussion This is the designated initializer for programmatic instantiation.
 *
 *  @return An initialized `ZNGMessagesViewController` object if successful, `nil` otherwise.
 */
