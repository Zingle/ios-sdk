...
static void * kZNGMessagesKeyValueObservingContext = &kZNGMessagesKeyValueObservingContext;



@interface ZNGMessagesViewController () <ZNGMessagesInputToolbarDelegate,
                                         ZNGMessagesKeyboardControllerDelegate>

@property (weak, nonatomic) IBOutlet ZNGMessagesCollectionView *collectionView;
@property (weak, nonatomic) IBOutlet ZNGMessagesInputToolbar *inputToolbar;
...
@implementation ZNGMessagesViewController

#pragma mark - Class methods

+ (UINib *)nib
{
    return [UINib nibWithNibName:NSStringFromClass([ZNGMessagesViewController class])
                          bundle:[NSBundle bundleForClass:[ZNGMessagesViewController class]]];
}

+ (instancetype)messagesViewController
{
    return [[[self class] alloc] initWithNibName:NSStringFromClass([ZNGMessagesViewController class])
                                          bundle:[NSBundle bundleForClass:[ZNGMessagesViewController class]]];
}
...
- (void)zng_configureMessagesViewController
{
    ...
    self.outgoingCellIdentifier = [ZNGMessagesCollectionViewCellOutgoing cellReuseIdentifier];
    self.outgoingMediaCellIdentifier = [ZNGMessagesCollectionViewCellOutgoing mediaCellReuseIdentifier];

    self.incomingCellIdentifier = [ZNGMessagesCollectionViewCellIncoming cellReuseIdentifier];
    self.incomingMediaCellIdentifier = [ZNGMessagesCollectionViewCellIncoming mediaCellReuseIdentifier];
    ...
    if (self.inputToolbar.contentView.textView != nil) {
        self.keyboardController = [[ZNGMessagesKeyboardController alloc] initWithTextView:self.inputToolbar.contentView.textView
...
- (void)setShowTypingIndicator:(BOOL)showTypingIndicator
{
    ...
    [self.collectionView.collectionViewLayout invalidateLayoutWithContext:[ZNGMessagesCollectionViewFlowLayoutInvalidationContext context]];
...
#pragma mark - ZNGMessages collection view data source
...
- (UICollectionViewCell *)collectionView:(ZNGMessagesCollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ZNGMessagesCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:cellIdentifier forIndexPath:indexPath];
...
- (UICollectionReusableView *)collectionView:(ZNGMessagesCollectionView *)collectionView
...
- (CGSize)collectionView:(UICollectionView *)collectionView
                  layout:(ZNGMessagesCollectionViewFlowLayout *)collectionViewLayout referenceSizeForFooterInSection:(NSInteger)section
{
    if (!self.showTypingIndicator) {
        return CGSizeZero;
    }

    return CGSizeMake([collectionViewLayout itemWidth], kZNGMessagesTypingIndicatorFooterViewHeight);
}

- (CGSize)collectionView:(UICollectionView *)collectionView
                  layout:(ZNGMessagesCollectionViewFlowLayout *)collectionViewLayout referenceSizeForHeaderInSection:(NSInteger)section
{
    if (!self.showLoadEarlierMessagesHeader) {
        return CGSizeZero;
    }

    return CGSizeMake([collectionViewLayout itemWidth], kZNGMessagesLoadEarlierHeaderViewHeight);
}

#pragma mark - Collection view delegate

- (BOOL)collectionView:(ZNGMessagesCollectionView *)collectionView shouldShowMenuForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ZNGMessagesCollectionViewCell *selectedCell = (ZNGMessagesCollectionViewCell *)[collectionView cellForItemAtIndexPath:indexPath];
...
- (void)collectionView:(ZNGMessagesCollectionView *)collectionView performAction:(SEL)action forItemAtIndexPath:(NSIndexPath *)indexPath withSender:(id)sender
{
...
- (CGSize)collectionView:(ZNGMessagesCollectionView *)collectionView
                  layout:(ZNGMessagesCollectionViewFlowLayout *)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath
{
...
- (void)messagesInputToolbar:(ZNGMessagesInputToolbar *)toolbar didPressLeftBarButton:(UIButton *)sender
{
...
- (void)messagesInputToolbar:(ZNGMessagesInputToolbar *)toolbar didPressRightBarButton:(UIButton *)sender
{
    if (toolbar.sendButtonOnRight) {
        [self didPressSendButton:sender
                 withMessageText:[self zng_currentlyComposedMessageText]
...
- (void)zng_didReceiveMenuWillShowNotification:(NSNotification *)notification
{
    ...
    ZNGMessagesCollectionViewCell *selectedCell = (ZNGMessagesCollectionViewCell *)[self.collectionView cellForItemAtIndexPath:self.selectedIndexPathForMenu];
...
{
    if (context == kZNGMessagesKeyValueObservingContext) {
...
- (void)keyboardController:(ZNGMessagesKeyboardController *)keyboardController keyboardDidChangeFrame:(CGRect)keyboardFrame
{
...
- (void)zng_addObservers
{
    ...
    [self.inputToolbar.contentView.textView addObserver:self
                                             forKeyPath:NSStringFromSelector(@selector(contentSize))
                                                ...
                                                context:kZNGMessagesKeyValueObservingContext];
