...
@interface ZNGMessagesBubbleImageFactory ()
...
- (ZNGMessagesBubbleImage *)zng_messagesBubbleImageWithColor:(UIColor *)color flippedForIncoming:(BOOL)flippedForIncoming;
...
@implementation ZNGMessagesBubbleImageFactory
...
- (ZNGMessagesBubbleImage *)zng_messagesBubbleImageWithColor:(UIColor *)color flippedForIncoming:(BOOL)flippedForIncoming
{
    ...
    return [[ZNGMessagesBubbleImage alloc] initWithMessageBubbleImage:normalBubble highlightedImage:highlightedBubble];
}
