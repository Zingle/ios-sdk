//
//  ZNGMessagesTimestampFormatter.h
//  Pods
//
...
/**
 *  An instance of `ZNGMessagesTimestampFormatter` is a singleton object that provides an efficient means 
 *  for creating attributed and non-attributed string representations of `NSDate` objects. 
 *  It is intended to be used as the method by which you display timestamps in a `ZNGMessagesCollectionView`.
 */
@interface ZNGMessagesTimestampFormatter : NSObject

/**
 *  Returns the cached date formatter object used by the `ZNGMessagesTimestampFormatter` shared instance.
 */
