...
@interface ZNGMessagesBubblesSizeCalculator ()
...
@implementation ZNGMessagesBubblesSizeCalculator
...
- (instancetype)init
{
    ...
    cache.name = @"ZNGMessagesBubblesSizeCalculator.cache";
...
#pragma mark - ZNGMessagesBubbleSizeCalculating
...
- (CGFloat)textBubbleWidthForLayout:(ZNGMessagesCollectionViewFlowLayout *)layout
{
...
- (CGFloat)widthForFixedWidthBubblesWithLayout:(ZNGMessagesCollectionViewFlowLayout *)layout {
