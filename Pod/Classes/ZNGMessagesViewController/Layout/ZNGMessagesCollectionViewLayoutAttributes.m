...
@interface ZNGMessagesCollectionViewLayoutAttributes ()
...
@implementation ZNGMessagesCollectionViewLayoutAttributes
...
- (BOOL)isEqual:(id)object
{
    ...
    if (self.representedElementCategory == UICollectionElementCategoryCell) {
        ZNGMessagesCollectionViewLayoutAttributes *layoutAttributes = (ZNGMessagesCollectionViewLayoutAttributes *)object;
...
{
    ZNGMessagesCollectionViewLayoutAttributes *copy = [super copyWithZone:zone];
