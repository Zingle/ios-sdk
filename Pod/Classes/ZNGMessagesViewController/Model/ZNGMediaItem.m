...
- (UIView *)mediaPlaceholderView
{
    if (self.cachedPlaceholderView == nil) {
        ...
        UIView *view = [ZNGMessagesMediaPlaceholderView viewWithActivityIndicator];
        view.frame = CGRectMake(0.0f, 0.0f, size.width, size.height);
        [ZNGMessagesMediaViewBubbleImageMasker applyBubbleImageMaskToMediaView:view isOutgoing:self.appliesMediaViewMaskAsOutgoing];
