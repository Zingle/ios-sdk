 ...
 *  a `ZNGMessagesViewController` and `ZNGMessagesCollectionView` interact with message model objects.
 *
 ...
 *  If this method returns `YES`, an instance of `ZNGMessagesViewController` will ignore 
 *  the `text` method of this protocol when dequeuing a `ZNGMessagesCollectionViewCell`
