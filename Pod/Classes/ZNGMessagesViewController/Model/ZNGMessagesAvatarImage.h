...
/**
 *  A `ZNGMessagesAvatarImage` model object represents an avatar image.
 *  This is a concrete class that implements the `ZNGMessageAvatarImageDataSource` protocol.
 ...
 */
@interface ZNGMessagesAvatarImage : NSObject <ZNGMessageAvatarImageDataSource, NSCopying>
 ...
 *
 *  @return An initialized `ZNGMessagesAvatarImage` object if successful, `nil` otherwise.
 */
