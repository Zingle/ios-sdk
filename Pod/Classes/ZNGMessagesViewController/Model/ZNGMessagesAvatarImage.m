...
@implementation ZNGMessagesAvatarImage 
...
+ (instancetype)avatarWithImage:(UIImage *)image
{
    ...
    return [[ZNGMessagesAvatarImage alloc] initWithAvatarImage:image
...
{
    return [[ZNGMessagesAvatarImage alloc] initWithAvatarImage:nil
