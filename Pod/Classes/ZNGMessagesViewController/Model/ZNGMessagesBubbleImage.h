...
/**
 *  A `ZNGMessagesBubbleImage` model object represents a message bubble image, and is immutable. 
 ...
 */
@interface ZNGMessagesBubbleImage : NSObject <ZNGMessageBubbleImageDataSource, NSCopying>
 ...
 *
 *  @return An initialized `ZNGMessagesBubbleImage` object if successful, `nil` otherwise.
 *
 *  @see ZNGMessagesBubbleImageFactory.
 */
