//
//  ZNGMessagesCollectionViewCell.h
//  Pods
//
...
/**
 *  The `ZNGMessagesCollectionViewCellDelegate` protocol defines methods that allow you to manage
 *  additional interactions within the collection view cell.
 */
@protocol ZNGMessagesCollectionViewCellDelegate <NSObject>
...
/**
 *  The `ZNGMessagesCollectionViewCell` is an abstract base class that presents the content for
 ...
 */
@interface ZNGMessagesCollectionViewCell : UICollectionViewCell

/**
 *  The object that acts as the delegate for the cell.
 */
@property (weak, nonatomic) id<ZNGMessagesCollectionViewCellDelegate> delegate;

/**
 *  Returns the label that is pinned to the top of the cell.
 *  This label is most commonly used to display message timestamps.
 */
@property (weak, nonatomic, readonly) ZNGMessagesLabel *cellTopLabel;
 ...
 */
@property (weak, nonatomic, readonly) ZNGMessagesLabel *messageBubbleTopLabel;
 ...
 */
@property (weak, nonatomic, readonly) ZNGMessagesLabel *cellBottomLabel;
 ...
 */
@property (weak, nonatomic, readonly) ZNGMessagesCellTextView *textView;
