...
static NSMutableSet *zngMessagesCollectionViewCellActions = nil;


@interface ZNGMessagesCollectionViewCell ()

@property (weak, nonatomic) IBOutlet ZNGMessagesLabel *cellTopLabel;
@property (weak, nonatomic) IBOutlet ZNGMessagesLabel *messageBubbleTopLabel;
@property (weak, nonatomic) IBOutlet ZNGMessagesLabel *cellBottomLabel;

@property (weak, nonatomic) IBOutlet UIView *messageBubbleContainerView;
@property (weak, nonatomic) IBOutlet UIImageView *messageBubbleImageView;
@property (weak, nonatomic) IBOutlet ZNGMessagesCellTextView *textView;
...
@implementation ZNGMessagesCollectionViewCell
...
+ (void)initialize
{
    ...
    dispatch_once(&onceToken, ^{
        zngMessagesCollectionViewCellActions = [NSMutableSet new];
    });
}
...
{
    [zngMessagesCollectionViewCellActions addObject:NSStringFromSelector(action)];
}
...
- (void)applyLayoutAttributes:(UICollectionViewLayoutAttributes *)layoutAttributes
{
    ...
    ZNGMessagesCollectionViewLayoutAttributes *customAttributes = (ZNGMessagesCollectionViewLayoutAttributes *)layoutAttributes;
    ...
    if ([self isKindOfClass:[ZNGMessagesCollectionViewCellIncoming class]]) {
        self.avatarViewSize = customAttributes.incomingAvatarViewSize;
    }
    else if ([self isKindOfClass:[ZNGMessagesCollectionViewCellOutgoing class]]) {
...
{
    if ([zngMessagesCollectionViewCellActions containsObject:NSStringFromSelector(aSelector)]) {
        return YES;
    }
...
{
    if ([zngMessagesCollectionViewCellActions containsObject:NSStringFromSelector(anInvocation.selector)]) {
