//
//  ZNGMessagesMediaPlaceholderView.h
//  Pods
//
...
/**
 *  A `ZNGMessagesMediaPlaceholderView` object represents a loading or placeholder
 ...
 *  the `ZNGMessageMediaData` protocol.
 *
 *  @see ZNGMessageMediaData.
 */
@interface ZNGMessagesMediaPlaceholderView : UIView
 ...
 *
 *  @discussion When initializing a `ZNGMessagesMediaPlaceholderView` with this method,
 *  its imageView property will be nil.
 *
 *  @return An initialized `ZNGMessagesMediaPlaceholderView` object if successful, `nil` otherwise.
 */
