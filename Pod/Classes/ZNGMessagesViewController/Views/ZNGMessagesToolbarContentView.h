//
//  ZNGMessagesToolbarContentView.h
//  Pods
//
 ...
 */
FOUNDATION_EXPORT const CGFloat kZNGMessagesToolbarContentViewHorizontalSpacingDefault;

/**
 *  A `ZNGMessagesToolbarContentView` represents the content displayed in a `ZNGMessagesInputToolbar`.
 ...
 */
@interface ZNGMessagesToolbarContentView : UIView

/**
 *  Returns the text view in which the user composes a message.
 */
@property (weak, nonatomic, readonly) ZNGMessagesComposerTextView *textView;
...
/**
 *  Returns the `UINib` object initialized for a `ZNGMessagesToolbarContentView`.
 *
