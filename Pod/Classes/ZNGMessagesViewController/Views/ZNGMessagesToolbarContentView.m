...
const CGFloat kZNGMessagesToolbarContentViewHorizontalSpacingDefault = 8.0f;


@interface ZNGMessagesToolbarContentView ()

@property (weak, nonatomic) IBOutlet ZNGMessagesComposerTextView *textView;
...
@implementation ZNGMessagesToolbarContentView

#pragma mark - Class methods

+ (UINib *)nib
{
    return [UINib nibWithNibName:NSStringFromClass([ZNGMessagesToolbarContentView class])
                          bundle:[NSBundle bundleForClass:[ZNGMessagesToolbarContentView class]]];
}
...
- (void)awakeFromNib
{
    ...
    self.leftHorizontalSpacingConstraint.constant = kZNGMessagesToolbarContentViewHorizontalSpacingDefault;
    self.rightHorizontalSpacingConstraint.constant = kZNGMessagesToolbarContentViewHorizontalSpacingDefault;
...
- (void)setLeftBarButtonItem:(UIButton *)leftBarButtonItem
{
    ...
    [self.leftBarButtonContainerView zng_pinAllEdgesOfSubview:leftBarButtonItem];
...
- (void)setRightBarButtonItem:(UIButton *)rightBarButtonItem
{
    ...
    [self.rightBarButtonContainerView zng_pinAllEdgesOfSubview:rightBarButtonItem];
    [self setNeedsUpdateConstraints];
