...
const CGFloat kZNGMessagesTypingIndicatorFooterViewHeight = 46.0f;


@interface ZNGMessagesTypingIndicatorFooterView ()
...
@implementation ZNGMessagesTypingIndicatorFooterView

#pragma mark - Class methods

+ (UINib *)nib
{
    return [UINib nibWithNibName:NSStringFromClass([ZNGMessagesTypingIndicatorFooterView class])
                          bundle:[NSBundle bundleForClass:[ZNGMessagesTypingIndicatorFooterView class]]];
}

+ (NSString *)footerReuseIdentifier
{
    return NSStringFromClass([ZNGMessagesTypingIndicatorFooterView class]);
}
                 ...
                 forCollectionView:(UICollectionView *)collectionView
{
    ...
    ZNGMessagesBubbleImageFactory *bubbleImageFactory = [[ZNGMessagesBubbleImageFactory alloc] init];
    ...
    self.typingIndicatorImageView.image = [[UIImage zng_defaultTypingIndicatorImage] zng_imageMaskedWithColor:ellipsisColor];
}
