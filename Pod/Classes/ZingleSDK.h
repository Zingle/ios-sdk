...
/**
 * Registers a new conversation in ZingleSDK. On success, system will receive all messages for specified contact ID. It will then be possible to create
 *  the UI for this conversation with conversationViewControllerForService:serviceId. Can be called as many times as needed to add all conversations.
 *
